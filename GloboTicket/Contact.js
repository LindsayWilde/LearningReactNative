...
const Contact = ({navigation}) => {
    ...
    const submit = () => { //function NOT a component for submission
        if(!formName || !formEmail || !formMessage){
            Alert.alert('Please enter info in all required fields');
        }
        else
        {
            Alert.alert(`Thank you ${formName}`); //notice the use of back ticks
    ...
    return(
        <View style={styles.form}>
            ...
            <Button
                title='Contact Us'
                color='#708090'
                onPress={submit} //this is the function that was created above
            />
        </View>
    );
}
